...
model = load_model('D:/Master work/Diss project/Code/Gesture project 21-05-2019/models/VGG_cross_validated.h5')
...
while camera.isOpened():
    ...
    if isBgCaptured == 1:
        ...
        cv2.putText(thresh, f"Prediction: {prediction} ({score}%)", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                    (255, 255, 255))
        cv2.putText(thresh, f"Action: {action}", (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                    (255, 255, 255))  
